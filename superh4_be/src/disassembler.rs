...
fn token_18(tokens: &[u8]) -> u8 {
    (((u16::from_be_bytes(tokens[0..2].try_into().unwrap()) >> 10) & 3) as u8)
}
...
impl ldc_l_instructionVar109 {
    ...
    fn parse(
        ...
        tokens_current = &tokens_current[usize::try_from(block_0_len).unwrap()..];
        *context = context_instance;
        Some((pattern_len, Self { BANKt, N_0t_bank1 }))
    }
}
...
impl Tableinstruction {
    ...
    fn parse(
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 0 && (tokens_param[1] & 255) == 72
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 0 && (tokens_param[1] & 255) == 56
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 0 && (tokens_param[1] & 255) == 88
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 0 && (tokens_param[1] & 255) == 171
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 255) == 227
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 64 && (tokens_param[1] & 255) == 62
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 64 && (tokens_param[1] & 255) == 78
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 64 && (tokens_param[1] & 255) == 55
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 64 && (tokens_param[1] & 255) == 71
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 255) == 195
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 255) == 147
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 255) == 163
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 255) == 179
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 255) == 131
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 255) == 50
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 255) == 66
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 255) == 58
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 255) == 250
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 64 && (tokens_param[1] & 255) == 51
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 64 && (tokens_param[1] & 255) == 67
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 64 && (tokens_param[1] & 255) == 50
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 143) == 130
        {
            if let Some((inst_len, parsed)) =
