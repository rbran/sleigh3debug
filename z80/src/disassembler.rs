...
impl Tableinstruction {
    ...
    fn parse(
        ...
        {
            if let Some((inst_len, parsed)) =
                LD_instructionVar101::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                LD_instructionVar102::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                ADC_instructionVar103::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                SBC_instructionVar104::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                ADD_instructionVar105::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                RLC_instructionVar107::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                RL_instructionVar108::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                RRC_instructionVar109::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                RR_instructionVar110::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                SLA_instructionVar111::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                SRA_instructionVar112::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                SRL_instructionVar113::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                BIT_instructionVar114::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                SET_instructionVar115::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                RES_instructionVar116::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                IN_instructionVar117::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                OUT_instructionVar118::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                BIT_instructionVar119::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                SET_instructionVar120::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                RES_instructionVar121::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 54 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar122::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 10 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar123::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 26 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar124::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 3 && (tokens_param[0] & 255) == 58 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar125::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 2 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar126::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 18 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar127::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 3 && (tokens_param[0] & 255) == 50 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar128::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 3 && (tokens_param[0] & 255) == 42 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar129::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 3 && (tokens_param[0] & 255) == 34 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar130::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 249 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar131::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 235 {
            if let Some((inst_len, parsed)) =
                EX_instructionVar132::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 8 {
            if let Some((inst_len, parsed)) =
                EX_instructionVar133::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 217 {
            if let Some((inst_len, parsed)) =
                EXX_instructionVar134::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 227 {
            if let Some((inst_len, parsed)) =
                EX_instructionVar135::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 198 {
            if let Some((inst_len, parsed)) =
                ADD_instructionVar136::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 206 {
            if let Some((inst_len, parsed)) =
                ADC_instructionVar138::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 142 {
            if let Some((inst_len, parsed)) =
                ADC_instructionVar139::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 214 {
            if let Some((inst_len, parsed)) =
                SUB_instructionVar140::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 222 {
            if let Some((inst_len, parsed)) =
                SBC_instructionVar142::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 158 {
            if let Some((inst_len, parsed)) =
                SBC_instructionVar143::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 166 {
            if let Some((inst_len, parsed)) =
                AND_instructionVar145::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 246 {
            if let Some((inst_len, parsed)) =
                OR_instructionVar146::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 182 {
            if let Some((inst_len, parsed)) =
                OR_instructionVar147::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 238 {
            if let Some((inst_len, parsed)) =
                XOR_instructionVar148::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 174 {
            if let Some((inst_len, parsed)) =
                XOR_instructionVar149::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 254 {
            if let Some((inst_len, parsed)) =
                CP_instructionVar150::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 190 {
            if let Some((inst_len, parsed)) =
                CP_instructionVar151::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 52 {
            if let Some((inst_len, parsed)) =
                INC_instructionVar152::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 53 {
            if let Some((inst_len, parsed)) =
                DEC_instructionVar153::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 39 {
            if let Some((inst_len, parsed)) =
                DAA_instructionVar154::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 47 {
            if let Some((inst_len, parsed)) =
                CPL_instructionVar155::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 63 {
            if let Some((inst_len, parsed)) =
                CCF_instructionVar156::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 55 {
            if let Some((inst_len, parsed)) =
                SCF_instructionVar157::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 0 {
            if let Some((inst_len, parsed)) =
                NOP_instructionVar158::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 118 {
            if let Some((inst_len, parsed)) =
                HALT_instructionVar159::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 243 {
            if let Some((inst_len, parsed)) =
                DI_instructionVar160::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 251 {
            if let Some((inst_len, parsed)) =
                EI_instructionVar161::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 7 {
            if let Some((inst_len, parsed)) =
                RLCA_instructionVar162::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 23 {
            if let Some((inst_len, parsed)) =
                RLA_instructionVar163::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 15 {
            if let Some((inst_len, parsed)) =
                RRCA_instructionVar164::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 31 {
            if let Some((inst_len, parsed)) =
                RRA_instructionVar165::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 3 && (tokens_param[0] & 255) == 195 {
            if let Some((inst_len, parsed)) =
                JP_instructionVar166::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 24 {
            if let Some((inst_len, parsed)) =
                JR_instructionVar167::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 233 {
            if let Some((inst_len, parsed)) =
                JP_instructionVar168::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 16 {
            if let Some((inst_len, parsed)) =
                DJNZ_instructionVar169::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 3 && (tokens_param[0] & 255) == 205 {
            if let Some((inst_len, parsed)) =
                CALL_instructionVar170::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 201 {
            if let Some((inst_len, parsed)) =
                RET_instructionVar171::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 219 {
            if let Some((inst_len, parsed)) =
                IN_instructionVar172::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 211 {
            if let Some((inst_len, parsed)) =
                OUT_instructionVar173::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 3 && (tokens_param[0] & 207) == 1 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar174::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 207) == 197 {
            if let Some((inst_len, parsed)) =
                PUSH_instructionVar175::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 207) == 193 {
            if let Some((inst_len, parsed)) =
                POP_instructionVar176::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 207) == 9 {
            if let Some((inst_len, parsed)) =
                ADD_instructionVar177::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 207) == 3 {
            if let Some((inst_len, parsed)) =
                INC_instructionVar178::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 207) == 11 {
            if let Some((inst_len, parsed)) =
                DEC_instructionVar179::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 199) == 6 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar180::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 199) == 70 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar181::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 248) == 112 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar182::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 248) == 136 {
            if let Some((inst_len, parsed)) =
                ADC_instructionVar184::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 248) == 152 {
            if let Some((inst_len, parsed)) =
                SBC_instructionVar186::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 248) == 176 {
            if let Some((inst_len, parsed)) =
                OR_instructionVar188::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 248) == 168 {
            if let Some((inst_len, parsed)) =
                XOR_instructionVar189::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 248) == 184 {
            if let Some((inst_len, parsed)) =
                CP_instructionVar190::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 3 && (tokens_param[0] & 199) == 194 {
            if let Some((inst_len, parsed)) =
                JP_instructionVar193::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 199) == 0 {
            if let Some((inst_len, parsed)) =
                JR_instructionVar194::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 3 && (tokens_param[0] & 199) == 196 {
            if let Some((inst_len, parsed)) =
                CALL_instructionVar195::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 199) == 192 {
            if let Some((inst_len, parsed)) =
                RET_instructionVar196::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 199) == 199 {
            if let Some((inst_len, parsed)) =
                RST_instructionVar197::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 192) == 64 {
            if let Some((inst_len, parsed)) =
                LD_instructionVar198::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
