...
impl Tableinstruction {
    ...
    fn parse(
        ...
        {
            if let Some((inst_len, parsed)) =
                dt_instructionVar14::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                tas_b_instructionVar15::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                rotcl_instructionVar16::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                rotcr_instructionVar17::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                rotl_instructionVar18::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                rotr_instructionVar19::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                shal_instructionVar20::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                shar_instructionVar21::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                shll_instructionVar22::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                shll2_instructionVar23::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                shll8_instructionVar24::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                shll16_instructionVar25::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                shlr_instructionVar26::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                shlr2_instructionVar27::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                shlr8_instructionVar28::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                shlr16_instructionVar29::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                braf_instructionVar30::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 255) == 3 {
            if let Some((inst_len, parsed)) =
                bsrf_instructionVar31::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                jmp_instructionVar32::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                jsr_instructionVar33::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                ldc_instructionVar34::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                ldc_l_instructionVar35::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                ldc_instructionVar36::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                ldc_l_instructionVar37::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                ldc_instructionVar38::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                ldc_l_instructionVar39::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                lds_instructionVar40::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                lds_l_instructionVar41::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                lds_instructionVar42::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                lds_l_instructionVar43::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                lds_instructionVar44::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                lds_l_instructionVar45::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 255) == 2 {
            if let Some((inst_len, parsed)) =
                stc_instructionVar46::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                stc_l_instructionVar47::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                stc_instructionVar48::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                stc_l_instructionVar49::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                stc_instructionVar50::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                stc_l_instructionVar51::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                sts_instructionVar52::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                sts_l_instructionVar53::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                sts_instructionVar54::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                sts_l_instructionVar55::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                sts_instructionVar56::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                sts_l_instructionVar57::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 199 {
            if let Some((inst_len, parsed)) =
                mova_instructionVar59::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 32 && (tokens_param[1] & 15) == 6 {
            if let Some((inst_len, parsed)) =
                mov_l_instructionVar71::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 132 {
            if let Some((inst_len, parsed)) =
                mov_b_instructionVar72::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 133 {
            if let Some((inst_len, parsed)) =
                mov_w_instructionVar73::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 128 {
            if let Some((inst_len, parsed)) =
                mov_b_instructionVar74::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 129 {
            if let Some((inst_len, parsed)) =
                mov_w_instructionVar75::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 192 {
            if let Some((inst_len, parsed)) =
                mov_b_instructionVar85::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 193 {
            if let Some((inst_len, parsed)) =
                mov_w_instructionVar86::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 194 {
            if let Some((inst_len, parsed)) =
                mov_l_instructionVar87::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 96 && (tokens_param[1] & 15) == 8 {
            if let Some((inst_len, parsed)) =
                swap_b_instructionVar88::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 96 && (tokens_param[1] & 15) == 9 {
            if let Some((inst_len, parsed)) =
                swap_w_instructionVar89::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                xtrct_instructionVar90::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                add_instructionVar91::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                addc_instructionVar92::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                addv_instructionVar93::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 48 && (tokens_param[1] & 15) == 6 {
            if let Some((inst_len, parsed)) =
                cmp_instructionVar98::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 48 && (tokens_param[1] & 15) == 7 {
            if let Some((inst_len, parsed)) =
                cmp_instructionVar99::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 32 && (tokens_param[1] & 15) == 7 {
            if let Some((inst_len, parsed)) =
                div0s_instructionVar101::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 48 && (tokens_param[1] & 15) == 4 {
            if let Some((inst_len, parsed)) =
                div1_instructionVar102::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                dmuls_l_instructionVar103::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 48 && (tokens_param[1] & 15) == 5 {
            if let Some((inst_len, parsed)) =
                dmulu_l_instructionVar104::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                exts_b_instructionVar105::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                exts_w_instructionVar106::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                extu_b_instructionVar107::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                extu_w_instructionVar108::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 15) == 15 {
            if let Some((inst_len, parsed)) =
                mac_l_instructionVar109::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                mac_w_instructionVar110::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 0 && (tokens_param[1] & 15) == 7 {
            if let Some((inst_len, parsed)) =
                mul_l_instructionVar111::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                muls_w_instructionVar112::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                mulu_w_instructionVar113::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                neg_instructionVar114::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                negc_instructionVar115::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 48 && (tokens_param[1] & 15) == 8 {
            if let Some((inst_len, parsed)) =
                sub_instructionVar116::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                subc_instructionVar117::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                subv_instructionVar118::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 32 && (tokens_param[1] & 15) == 9 {
            if let Some((inst_len, parsed)) =
                and_instructionVar119::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 201 {
            if let Some((inst_len, parsed)) =
                and_instructionVar120::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 205 {
            if let Some((inst_len, parsed)) =
                and_b_instructionVar121::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 96 && (tokens_param[1] & 15) == 7 {
            if let Some((inst_len, parsed)) =
                not_instructionVar122::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                or_instructionVar123::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 203 {
            if let Some((inst_len, parsed)) =
                or_instructionVar124::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 207 {
            if let Some((inst_len, parsed)) =
                or_b_instructionVar125::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 32 && (tokens_param[1] & 15) == 8 {
            if let Some((inst_len, parsed)) =
                tst_instructionVar126::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 200 {
            if let Some((inst_len, parsed)) =
                tst_instructionVar127::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 204 {
            if let Some((inst_len, parsed)) =
                tst_b_instructionVar128::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                xor_instructionVar129::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 202 {
            if let Some((inst_len, parsed)) =
                xor_instructionVar130::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 206 {
            if let Some((inst_len, parsed)) =
                xor_b_instructionVar131::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 139 {
            if let Some((inst_len, parsed)) =
                bf_instructionVar132::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 143 {
            if let Some((inst_len, parsed)) =
                bf_instructionVar133::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 137 {
            if let Some((inst_len, parsed)) =
                bt_instructionVar134::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 141 {
            if let Some((inst_len, parsed)) =
                bt_instructionVar135::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 195 {
            if let Some((inst_len, parsed)) =
                trapa_instructionVar136::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 80 {
            if let Some((inst_len, parsed)) =
                mov_l_instructionVar140::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 16 {
            if let Some((inst_len, parsed)) =
                mov_l_instructionVar141::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 112 {
            if let Some((inst_len, parsed)) =
                add_instructionVar142::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 160 {
            if let Some((inst_len, parsed)) =
                bra_instructionVar143::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 240) == 176 {
            if let Some((inst_len, parsed)) =
                bsr_instructionVar144::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
