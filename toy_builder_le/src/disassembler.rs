...
fn token_12(tokens: &[u8]) -> u8 {
    (((u16::from_le_bytes(tokens[0..2].try_into().unwrap()) >> 12) & 3) as u8)
}
...
impl Tableinstruction {
    ...
    fn parse(
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 192
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 193
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 194
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 195
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 196
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 197
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 198
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 199
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 200
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 201
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 202
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 203
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 204
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 205
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 206
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 207
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 208
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 209
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 210
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 211
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 212
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 213
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 216
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 219
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 220
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 221
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 214
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 215
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 223
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 245
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 164
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 255) == 165
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 248) == 248
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 192) == 128
        {
            if let Some((inst_len, parsed)) =
                simm_instructionVar57::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var57(parsed)));
            }
        }
        if tokens_param.len() >= 2 && context_param.0 & 768 == 512 && (tokens_param[1] & 128) == 0 {
            if let Some((inst_len, parsed)) =
                imm_instructionVar58::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        {
            if let Some((inst_len, parsed)) =
                nop_instructionVar59::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
...
impl TableCC {
    ...
    fn parse(
        ...
        let mut context_current = context_param.clone();
        if tokens_param.len() >= 2 && (tokens_param[0] & 7) == 0 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 7) == 1 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 7) == 2 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 7) == 3 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 7) == 4 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 7) == 5 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 7) == 6 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 7) == 7 {
            if let Some((inst_len, parsed)) =
