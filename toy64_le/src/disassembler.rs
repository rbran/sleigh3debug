...
impl Tableinstruction {
    ...
    fn parse(
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 0 && (tokens_param[1] & 255) == 244
        {
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 0 && (tokens_param[1] & 255) == 163
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 0 && (tokens_param[1] & 255) == 168
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 15) == 0 && (tokens_param[1] & 255) == 222
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 15) == 1 && (tokens_param[1] & 255) == 222
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 248) == 0 && (tokens_param[1] & 255) == 128
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 15) == 0 && (tokens_param[1] & 255) == 242
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 15) == 0 && (tokens_param[1] & 255) == 243
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 15) == 0 && (tokens_param[1] & 255) == 246
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 15) == 0 && (tokens_param[1] & 255) == 161
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 15) == 0 && (tokens_param[1] & 255) == 162
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 15) == 0 && (tokens_param[1] & 255) == 166
        {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 8) == 0 && (tokens_param[1] & 255) == 240 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 8) == 0 && (tokens_param[1] & 255) == 241 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 8) == 8 && (tokens_param[1] & 255) == 246 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 208 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 209 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 210 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 211 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 212 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 213 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 216 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 219 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 220 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 221 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 214 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 215 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 223 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 8) == 0 && (tokens_param[1] & 240) == 224 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 8) == 8 && (tokens_param[1] & 240) == 224 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 245 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 164 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 255) == 165 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 2 && (tokens_param[1] & 248) == 248 {
            if let Some((inst_len, parsed)) =
