...
impl TableEA {
    ...
    fn parse(
        ...
        if tokens_param.len() >= 3 && (tokens_param[0] & 255) == 175 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 207 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 144 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 3 && (tokens_param[0] & 255) == 176 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 159) == 135 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 159) == 138 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 159) == 142 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 159) == 151 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 159) == 154 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 159) == 158 {
            if let Some((inst_len, parsed)) =
...
impl EXG_r0TmpVar6 {
    fn display_extend(
        ...
        let extend: [DisplayElement; 1usize] = [<DisplayElement>::Register(Register::W)];
        display.extend_from_slice(&extend);
    }
    fn parse(
        mut tokens_current: &[u8],
...
impl EXG_r0TmpVar7 {
    fn display_extend(
        ...
        let extend: [DisplayElement; 1usize] = [<DisplayElement>::Register(Register::V)];
        display.extend_from_slice(&extend);
    }
    fn parse(
        mut tokens_current: &[u8],
...
impl EXG_r0TmpVar14 {
    fn display_extend(
        ...
        let extend: [DisplayElement; 1usize] = [<DisplayElement>::Register(Register::E)];
        display.extend_from_slice(&extend);
    }
    fn parse(
        mut tokens_current: &[u8],
...
impl EXG_r0TmpVar15 {
    fn display_extend(
        ...
        let extend: [DisplayElement; 1usize] = [<DisplayElement>::Register(Register::F)];
        display.extend_from_slice(&extend);
    }
    fn parse(
        mut tokens_current: &[u8],
