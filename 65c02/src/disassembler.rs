...
#[derive(Clone, Debug)]
struct BRA_instructionVar51 {
    REL: TableREL,
}
impl BRA_instructionVar51 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
...
#[derive(Clone, Debug)]
struct DEC_instructionVar52 {}
impl DEC_instructionVar52 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
...
#[derive(Clone, Debug)]
struct INC_instructionVar53 {}
impl INC_instructionVar53 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
...
#[derive(Clone, Debug)]
struct JMP_instructionVar54 {
    ADDRIX: TableADDRIX,
}
impl JMP_instructionVar54 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
    ...
    fn parse(
        ...
        let ADDRIX = if let Some((len, table)) =
            TableADDRIX::parse(tokens_current, &mut context_instance, inst_start)
        {
            block_1_len = block_1_len.max(len as AddrType);
            table
        } else {
...
#[derive(Clone, Debug)]
struct PHX_instructionVar55 {}
impl PHX_instructionVar55 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
        ...
        display.push(DisplayElement::Literal("PHX"));
    }
    fn parse(
        mut tokens_current: &[u8],
        context: &mut ContextMemory,
...
#[derive(Clone, Debug)]
struct PLX_instructionVar56 {}
impl PLX_instructionVar56 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
        ...
        display.push(DisplayElement::Literal("PLX"));
    }
    fn parse(
        mut tokens_current: &[u8],
        context: &mut ContextMemory,
...
#[derive(Clone, Debug)]
struct PHY_instructionVar57 {}
impl PHY_instructionVar57 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
        ...
        display.push(DisplayElement::Literal("PHY"));
    }
    fn parse(
        mut tokens_current: &[u8],
        context: &mut ContextMemory,
...
#[derive(Clone, Debug)]
struct PLY_instructionVar58 {}
impl PLY_instructionVar58 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
        ...
        display.push(DisplayElement::Literal("PLY"));
    }
    fn parse(
        mut tokens_current: &[u8],
        context: &mut ContextMemory,
...
#[derive(Clone, Debug)]
struct STZ_instructionVar59 {
    imm8: u8,
}
impl STZ_instructionVar59 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
        ...
        display.push(DisplayElement::Literal("STZ"));
        let extend: [DisplayElement; 2usize] = [
            <DisplayElement>::Literal(" "),
            DisplayElement::Number(true, false, self.imm8 as u64),
        ];
...
#[derive(Clone, Debug)]
struct STZ_instructionVar60 {
    imm8: u8,
}
impl STZ_instructionVar60 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
...
#[derive(Clone, Debug)]
struct STZ_instructionVar61 {
    imm16: u16,
}
impl STZ_instructionVar61 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
...
#[derive(Clone, Debug)]
struct STZ_instructionVar62 {
    imm16: u16,
}
impl STZ_instructionVar62 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
...
#[derive(Clone, Debug)]
struct TRB_instructionVar63 {
    OPTB: TableOPTB,
}
impl TRB_instructionVar63 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
        ...
        display.push(DisplayElement::Literal("TRB"));
        let extend: [DisplayElement; 1usize] = [<DisplayElement>::Literal(" ")];
        display.extend_from_slice(&extend);
        self.OPTB
            .display_extend(display, context, inst_start, inst_next, global_set);
...
#[derive(Clone, Debug)]
struct TSB_instructionVar64 {
    OPTB: TableOPTB,
}
impl TSB_instructionVar64 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
        ...
        display.push(DisplayElement::Literal("TSB"));
        let extend: [DisplayElement; 1usize] = [<DisplayElement>::Literal(" ")];
        display.extend_from_slice(&extend);
        self.OPTB
            .display_extend(display, context, inst_start, inst_next, global_set);
...
#[derive(Clone, Debug)]
struct ADC_instructionVar65 {
    OP1: TableOP1,
}
impl ADC_instructionVar65 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
...
#[derive(Clone, Debug)]
struct AND_instructionVar66 {
    OP1: TableOP1,
}
impl AND_instructionVar66 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
...
#[derive(Clone, Debug)]
struct EOR_instructionVar68 {
    OP1: TableOP1,
}
impl EOR_instructionVar68 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
...
#[derive(Clone, Debug)]
struct LDA_instructionVar69 {
    OP1: TableOP1,
}
impl LDA_instructionVar69 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
...
#[derive(Clone, Debug)]
struct ORA_instructionVar70 {
    OP1: TableOP1,
}
impl ORA_instructionVar70 {
    fn display_extend(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &ContextMemory,
...
impl BBR_instructionVar75 {
    fn display_extend(
        ...
        display.push(DisplayElement::Literal("BBR"));
        let extend: [DisplayElement; 8usize] = [
            <DisplayElement>::Literal(" "),
            <DisplayElement>::Literal("#"),
            DisplayElement::Number(false, false, self.bitindex as u64),
            <DisplayElement>::Literal(","),
            <DisplayElement>::Literal(" "),
            DisplayElement::Number(true, false, self.imm8 as u64),
            <DisplayElement>::Literal(","),
    ...
    fn parse(
        ...
        let ((), (), sub_len) = sub_pattern_c35(tokens_current, &mut context_instance)?;
        block_0_len = block_0_len.max(sub_len);
        let bitindex = token_7(tokens_current);
        pattern_len += block_0_len;
        tokens_current = &tokens_current[usize::try_from(block_0_len).unwrap()..];
        let mut block_1_len = 1;
        let imm8 = token_1(tokens_current);
...
impl BBS_instructionVar76 {
    fn display_extend(
        ...
        display.push(DisplayElement::Literal("BBS"));
        let extend: [DisplayElement; 8usize] = [
            <DisplayElement>::Literal(" "),
            <DisplayElement>::Literal("#"),
            DisplayElement::Number(false, false, self.bitindex as u64),
...
impl RMB_instructionVar81 {
    fn display_extend(
        ...
        display.push(DisplayElement::Literal("RMB"));
...
impl SMB_instructionVar83 {
    fn display_extend(
        ...
        display.push(DisplayElement::Literal("SMB"));
        let extend: [DisplayElement; 6usize] = [
            <DisplayElement>::Literal(" "),
            <DisplayElement>::Literal("#"),
            DisplayElement::Number(false, false, self.bitindex as u64),
...
enum Tableinstruction {
    ...
    Var51(BRA_instructionVar51),
    Var52(DEC_instructionVar52),
    Var53(INC_instructionVar53),
    Var54(JMP_instructionVar54),
    Var55(PHX_instructionVar55),
    Var56(PLX_instructionVar56),
    Var57(PHY_instructionVar57),
    Var58(PLY_instructionVar58),
    Var59(STZ_instructionVar59),
    Var60(STZ_instructionVar60),
    Var61(STZ_instructionVar61),
    Var62(STZ_instructionVar62),
    Var63(TRB_instructionVar63),
    Var64(TSB_instructionVar64),
    Var65(ADC_instructionVar65),
    Var66(AND_instructionVar66),
    Var67(CMP_instructionVar67),
    Var68(EOR_instructionVar68),
    Var69(LDA_instructionVar69),
    Var70(ORA_instructionVar70),
...
impl Tableinstruction {
    ...
    fn parse(
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 137 {
            if let Some((inst_len, parsed)) =
                BIT_instructionVar49::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var49(parsed)));
            }
        }
        if tokens_param.len() >= 1 && (tokens_param[0] & 247) == 52 {
            if let Some((inst_len, parsed)) =
                BIT_instructionVar50::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 128 {
            if let Some((inst_len, parsed)) =
                BRA_instructionVar51::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 58 {
            if let Some((inst_len, parsed)) =
                DEC_instructionVar52::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 26 {
            if let Some((inst_len, parsed)) =
                INC_instructionVar53::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 3 && (tokens_param[0] & 255) == 124 {
            if let Some((inst_len, parsed)) =
                JMP_instructionVar54::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var54(parsed)));
            }
        }
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 218 {
            if let Some((inst_len, parsed)) =
                PHX_instructionVar55::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 250 {
            if let Some((inst_len, parsed)) =
                PLX_instructionVar56::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 90 {
            if let Some((inst_len, parsed)) =
                PHY_instructionVar57::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 1 && (tokens_param[0] & 255) == 122 {
            if let Some((inst_len, parsed)) =
                PLY_instructionVar58::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 100 {
            if let Some((inst_len, parsed)) =
                STZ_instructionVar59::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 255) == 116 {
            if let Some((inst_len, parsed)) =
                STZ_instructionVar60::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var60(parsed)));
            }
        }
        if tokens_param.len() >= 3 && (tokens_param[0] & 255) == 156 {
            if let Some((inst_len, parsed)) =
                STZ_instructionVar61::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var61(parsed)));
            }
        }
        if tokens_param.len() >= 3 && (tokens_param[0] & 255) == 158 {
            if let Some((inst_len, parsed)) =
                STZ_instructionVar62::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var62(parsed)));
            }
        }
        if tokens_param.len() >= 2 && (tokens_param[0] & 243) == 16 {
            if let Some((inst_len, parsed)) =
                TRB_instructionVar63::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var63(parsed)));
            }
        }
        if tokens_param.len() >= 2 && (tokens_param[0] & 243) == 0 {
            if let Some((inst_len, parsed)) =
                TSB_instructionVar64::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 97 {
            if let Some((inst_len, parsed)) =
                ADC_instructionVar65::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 33 {
            if let Some((inst_len, parsed)) =
                AND_instructionVar66::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 65 {
            if let Some((inst_len, parsed)) =
                EOR_instructionVar68::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 161 {
            if let Some((inst_len, parsed)) =
                LDA_instructionVar69::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 1 {
            if let Some((inst_len, parsed)) =
                ORA_instructionVar70::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 225 {
            if let Some((inst_len, parsed)) =
                SBC_instructionVar71::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 129 {
            if let Some((inst_len, parsed)) =
                STA_instructionVar72::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var72(parsed)));
            }
        }
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 98 {
            if let Some((inst_len, parsed)) =
                ADC_instructionVar73::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var73(parsed)));
            }
        }
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 34 {
            if let Some((inst_len, parsed)) =
                AND_instructionVar74::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var74(parsed)));
            }
        }
        if tokens_param.len() >= 3 && (tokens_param[0] & 143) == 15 {
            if let Some((inst_len, parsed)) =
                BBR_instructionVar75::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var75(parsed)));
            }
        }
        if tokens_param.len() >= 3 && (tokens_param[0] & 143) == 143 {
            if let Some((inst_len, parsed)) =
                BBS_instructionVar76::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var76(parsed)));
            }
        }
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 194 {
            if let Some((inst_len, parsed)) =
                CMP_instructionVar77::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var77(parsed)));
            }
        }
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 66 {
            if let Some((inst_len, parsed)) =
                EOR_instructionVar78::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var78(parsed)));
            }
        }
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 162 {
            if let Some((inst_len, parsed)) =
                LDA_instructionVar79::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var79(parsed)));
            }
        }
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 2 {
            if let Some((inst_len, parsed)) =
                ORA_instructionVar80::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
        ...
        if tokens_param.len() >= 2 && (tokens_param[0] & 143) == 7 {
            if let Some((inst_len, parsed)) =
                RMB_instructionVar81::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var81(parsed)));
            }
        }
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 226 {
            if let Some((inst_len, parsed)) =
                SBC_instructionVar82::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var82(parsed)));
            }
        }
        if tokens_param.len() >= 2 && (tokens_param[0] & 143) == 135 {
            if let Some((inst_len, parsed)) =
                SMB_instructionVar83::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
                return Some((inst_len, Self::Var83(parsed)));
            }
        }
        if tokens_param.len() >= 2 && (tokens_param[0] & 227) == 130 {
            if let Some((inst_len, parsed)) =
                STA_instructionVar84::parse(tokens_param, &mut context_current, inst_start)
            {
                *context_param = context_current;
...
impl TableOPTB {
    ...
    fn parse(
        ...
        let mut context_current = context_param.clone();
        if tokens_param.len() >= 2 && (tokens_param[0] & 12) == 4 {
            if let Some((inst_len, parsed)) =
        ...
        if tokens_param.len() >= 3 && (tokens_param[0] & 12) == 12 {
            if let Some((inst_len, parsed)) =
